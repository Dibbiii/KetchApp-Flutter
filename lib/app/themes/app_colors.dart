...
const Color onPrimaryColorLight = Color(0xFFFFFFFF); // Text/icons on primaryColor

const Color secondaryColorLight = Color(0xFF555F71); // Secondary elements, accents
const Color onSecondaryColorLight = Color(
  0xFFFFFFFF,
); // Text/icons on secondaryColor

const Color tertiaryColorLight = Color(0xFF6B5778); // Tertiary elements, accents
const Color onTertiaryColorLight = Color(0xFFFFFFFF); // Text/icons on tertiaryColor
...
const Color surfaceColorLight = Color(0xFFFDFBFF); // Backgrounds for cards, sheets
const Color onSurfaceColorLight = Color(0xFF1A1C1E); // Text/icons on surfaceColor
...
const Color snackBarBackgroundColorLight = Color(0xFF323232); // SnackBar background
...
const Color focusColorLight = Color(0x1F000000); // Typically a translucent version of a color
const Color hoverColorLight = Color(0x0A000000); // Typically a very translucent version of a color
const Color canvasColorLight = Color(0xFFFAFAFA); // Light grey/white for canvas
const Color dividerColorLight = Color(0x1F000000); // Typically a translucent black or grey
...
const Color unselectedWidgetColorLight = Color(0x8A000000); // Semi-transparent black
const Color disabledColorLight = Color(0x61000000); // Semi-transparent black
const Color secondaryHeaderColorLight = Color(0xFFE3F2FD); // Light blue, often used for secondary headers


// Dark Theme Colors
const Color primaryColorDark = Color(0xFF74AEFF); // A lighter blue for dark mode
const Color onPrimaryColorDark = Color(0xFF003062); // Darker text/icons on primaryColorDark

const Color secondaryColorDark = Color(0xFFB8C8DC); // Lighter secondary for dark mode
const Color onSecondaryColorDark = Color(0xFF283241); // Darker text/icons on secondaryColorDark

const Color tertiaryColorDark = Color(0xFFD7BDE2); // Lighter tertiary for dark mode
const Color onTertiaryColorDark = Color(0xFF3B2948); // Darker text/icons on tertiaryColorDark

const Color errorColorDark = Color(0xFFFFB4AB); // Lighter error red for dark mode
const Color onErrorColorDark = Color(0xFF690005); // Darker text/icons on errorColorDark

const Color surfaceColorDark = Color(0xFF121316); // Dark background for cards, sheets
const Color onSurfaceColorDark = Color(0xFFE2E2E6); // Lighter text/icons on surfaceColorDark

const Color backgroundColorDark = Color(0xFF121316); // Dark background
const Color onBackgroundColorDark = Color(0xFFE2E2E6); // Lighter text/icons on backgroundColorDark

const Color snackBarBackgroundColorDark = Color(0xFFE2E2E6); // SnackBar background (light for contrast)
const Color onSnackBarBackgroundColorDark = Color(0xFF121316); // SnackBar text/icons (dark for contrast)
...
const Color shadowColorDark = Color(0xFF000000); // Shadow color can often be the same
const Color focusColorDark = Color(0x1FFFFFFF); // Typically a translucent version of a color (light for dark theme)
const Color hoverColorDark = Color(0x0AFFFFFF); // Typically a very translucent version of a color (light for dark theme)
const Color canvasColorDark = Color(0xFF1E1E1E); // Dark grey for canvas
const Color dividerColorDark = Color(0x1FFFFFFF); // Typically a translucent white or grey
const Color highlightColorDark = Color(0x40CCCCCC); // Semi-transparent light grey
const Color splashColorDark = Color(0x40CCCCCC); // Semi-transparent light grey
const Color unselectedWidgetColorDark = Color(0x8AFFFFFF); // Semi-transparent white
const Color disabledColorDark = Color(0x61FFFFFF); // Semi-transparent white
const Color secondaryHeaderColorDark = Color(0xFF1E2A3A); // Dark blue, often used for secondary headers
